...
- Add a Rust-only Calculator example with tested arithmetic state transitions, an Android-ready Slint UI, and a user-confirmed physical Android launch and interaction.
